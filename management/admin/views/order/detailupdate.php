...
<div class="box-detail">
    <div class="box-title c">
        <h1><i class="fa fa-table"></i>用户订单详细信息</h1>
        <a class="btn" href="<?php echo $this->createUrl('DetailIndex',array('id'=>$model_order->id)); ?>"><i class="fa fa-reply"></i>返回</a>
    ...
    <div class="mt15">
        <table style='margin-top:5px;' align="center">
            <tr>
                <td ><?php echo $form->labelEx($model_order, 'order_num'); ?></td>
                <td  ><?php echo $model_order->order_num; ?></td>
    ...
    <div class="box-detail-submit">
        ...
        <a class="btn" href="<?php echo $this->createUrl('DetailIndex',array('id'=>$model_order->id)); ?>">返回</a>
        <?php $this->endWidget(); ?>
    </div>
</div>
