<div class="box">
    <div class="box-content">
        <div class="box-header">
            <a class="btn"
               href="<?php echo $this->createUrl('detailcreate', array('id' => $model_order->id)); ?>"><i
                    class="fa fa-plus"></i>添加用户订单详细信息</a>
            ...
            <h1 align="center">用户订单详情页</h1>
            <table class="salesreturn">
                <tr>
                    <th><?php echo $model_order->getAttributeLabel('order_num') . ':' . $model_order->order_num . '<br>'; ?></th>
                </tr>
            </table>
            <div class="box-table">
                <table class="list">
                    ...
                    <?php foreach ($arclist as $v) { ?>
                        <tr>
                            ...
                            <td title="编辑详细信息"><?php echo CHtml::link($v->name, array('detailupdate','id_orderdetail' => $v->id, 'id_order' => $model_order->id)); ?></td>
                            ...
                            <td>
                                <a class="btn"
                                   href="<?php echo $this->createUrl('detailupdate', array('id_orderdetail' => $v->id, 'id_order' => $model_order->id)); ?>"
